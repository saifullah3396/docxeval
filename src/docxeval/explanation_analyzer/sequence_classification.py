...
from atria_insights.configs.explanation_task_config import LoggingConfig
from atria_insights.explainability_metrics import (
    AOPCConfig,  # noqa
...
from docxeval.explanation_analyzer.explanation_analyzer import (
    ModelExplanationAnalyzer,
    ModelExplanationAnalyzerConfig,
)
...
_EXPLAINERS = {
    ...
    "attn/raw_attention": AttentionExplainerConfig(),
    "attn/attention_rollout": AttentionRolloutExplainerConfig(),
    "attn/attention_flow": AttentionFlowExplainerConfig(),
}
...
def main(
    ...
    mode: Literal["single", "batch", "save", "prepare_metrics"] = "prepare_metrics",
    n_batches: int = 1,
    ...
    explainer_name: str = "grad/input_x_gradient",
    builder_type: ModelBuilderType = ModelBuilderType.atria,
    exp_name: str = "experiment_02_seq_cls",
    ...
    x_model_pipeline = "sequence_classification"
    if explainer_name.startswith("attn/"):
        x_model_pipeline = "attn_sequence_classification"
