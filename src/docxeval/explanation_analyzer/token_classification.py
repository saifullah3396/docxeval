...
_METRICS = {
    ...
    **{
    ...
    "faithfulness/faithfulness_estimate": FaithfulnessEstimateConfig(
        max_features_processed_per_batch=50,
        percentage_feature_removal_per_step=0.01,
        show_progress=True,
    ),
...
def main(
    ...
    explanations_dir: str = "experiment_02_token_cls",
    ...
    x_model_pipeline = "token_classification"
    if explainer_name.startswith("attn/"):
        x_model_pipeline = "attn_token_classification"
