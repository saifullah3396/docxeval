...
# Build file path
data <- read.csv(file.path(script_dir, output_dir, dataset, "dataset_wise_summarized_xai_metrics_scaled.csv"))
...
ggsave(
    file.path(script_dir, output_dir, dataset, "xai_methods_comparison_scaled.png"),
