...
# Load the data
data <- read.csv(file.path(script_dir, output_dir, dataset, "dataset_wise_mean/Single-Feature-Perturbation-Abs-Fwd-Diffs.csv"))
...
# Save plot
ggsave(
    filename = file.path(script_dir, output_dir, paste0(dataset, "_single_feature_fwd_diff_hist.png")),
    plot = p,
