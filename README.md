...
This repository contains the datasets and code for the paper DocXEval: A Systematic Evaluation of Explainability in Multimodal Document Understanding by Saifullah, Stefan Agne, Andreas Dengel, and Sheraz Ahmed. Requires Python 3.11.
